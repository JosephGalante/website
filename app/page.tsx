        ...
        <Reveal className="hero-shell">
          <section className="hero-section">
            ...
            <p className="hero-copy">
              I&apos;m a Software Engineer with an insatiable passion for learning
              new technologies. Right now, I&apos;m on the hunt for a new
              opportunity.
            </p>
          ...
          <section className="content-section" aria-labelledby="about">
            ...
            <div className="about-layout">
              <div className="about-copy">
                <p>
                  Hey there! I&apos;m Joseph Galante, but you can just call me Joe.
                  I&apos;m a recent graduate from the{' '}
                  <a href="https://www.pitt.edu" target="_blank" rel="noreferrer">
                    University of Pittsburgh
                  </a>{' '}
                  with a degree in Computer Science and Finance.
                </p>
                <p>
                  My analytical background is paired with my adventurous spirit,
                  as I love to rock climb and explore the great outdoors.
                </p>
                <p>
                  Currently, I&apos;m looking for a new opportunity as a Software
                  Engineer. If you&apos;re looking for a passionate and eager to
        ...
        <Reveal>
          <section className="contact-section" id="contact" aria-labelledby="contact-heading">
            ...
            <p>
              ...
              in working together, or just want to say hi, feel free to reach out
